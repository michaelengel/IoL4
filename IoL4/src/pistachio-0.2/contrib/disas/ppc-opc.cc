...
/* This file was extracted from gdb and added to the l4 kernel debugger.
 */
...
insert_bat (unsigned long insn, long value ATTRIBUTE_UNUSED, const char **errmsg ATTRIBUTE_UNUSED)
{
...
/*ARGSUSED*/
static unsigned long
insert_bba (unsigned long insn, long value ATTRIBUTE_UNUSED, const char **errmsg ATTRIBUTE_UNUSED)
{
...
/*ARGSUSED*/
static unsigned long
insert_bd (unsigned long insn, long value, const char **errmsg ATTRIBUTE_UNUSED)
{
...
/*ARGSUSED*/
static long
extract_bd (unsigned long insn, int *invalid ATTRIBUTE_UNUSED)
{
  if ((insn & 0x8000) != 0)
...
/*ARGSUSED*/
static unsigned long
insert_bdm (unsigned long insn, long value, const char **errmsg ATTRIBUTE_UNUSED)
{
  if ((value & 0x8000) != 0)
    insn |= 1 << 21;
  return insn | (value & 0xfffc);
...
/*ARGSUSED*/
static unsigned long
insert_bdp (unsigned long insn, long value, const char **errmsg ATTRIBUTE_UNUSED)
{
  if ((value & 0x8000) == 0)
    insn |= 1 << 21;
  return insn | (value & 0xfffc);
...
/*ARGSUSED*/
static unsigned long
insert_ds (unsigned long insn, long value, const char **errmsg ATTRIBUTE_UNUSED)
{
  return insn | (value & 0xfffc);
}
...
/*ARGSUSED*/
static long
extract_ds (unsigned long insn, int *invalid ATTRIBUTE_UNUSED)
{
  if ((insn & 0x8000) != 0)
    return (insn & 0xfffc) - 0x10000;
  else
...
/*ARGSUSED*/
static long
extract_li (unsigned long insn, int *invalid ATTRIBUTE_UNUSED)
{
  if ((insn & 0x2000000) != 0)
...
/*ARGSUSED*/
static unsigned long
insert_mb6 (unsigned long insn, long value, const char **errmsg ATTRIBUTE_UNUSED)
{
...
/*ARGSUSED*/
static long
extract_mb6 (unsigned long insn, int *invalid ATTRIBUTE_UNUSED)
{
...
/*ARGSUSED*/
static long
extract_nb (unsigned long insn, int *invalid ATTRIBUTE_UNUSED)
{
  long ret;
...
/*ARGSUSED*/
static unsigned long
insert_nsi (unsigned long insn, long value, const char **errmsg ATTRIBUTE_UNUSED)
{
...
/*ARGSUSED*/
static unsigned long
insert_rbs (unsigned long insn, long value ATTRIBUTE_UNUSED, const char **errmsg ATTRIBUTE_UNUSED)
{
...
/*ARGSUSED*/
static unsigned long
insert_sh6 ( unsigned long insn, long value, const char **errmsg ATTRIBUTE_UNUSED )
{
...
/*ARGSUSED*/
static long
extract_sh6 ( unsigned long insn, int *invalid ATTRIBUTE_UNUSED )
{
...
static unsigned long
insert_spr ( unsigned long insn, long value, const char **errmsg ATTRIBUTE_UNUSED )
{
  return insn | ((value & 0x1f) << 16) | ((value & 0x3e0) << 6);
}

static long
extract_spr ( unsigned long insn, int *invalid ATTRIBUTE_UNUSED )
{
...
static unsigned long
insert_tbr ( unsigned long insn, long value, const char **errmsg ATTRIBUTE_UNUSED )
{
  if (value == 0)
    value = TB;
  return insn | ((value & 0x1f) << 16) | ((value & 0x3e0) << 6);
...
static long
extract_tbr ( unsigned long insn, int *invalid ATTRIBUTE_UNUSED )
{
  long ret;
